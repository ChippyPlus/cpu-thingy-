...
suspend fun Instruction.eq(register1: RegisterValue, register2: RegisterValue, register3: RegisterAddress): WriteBackOutput_old {
    useful
    val result = alu_eq(register1.value, register2.value)
    return WriteBackOutput_old(result, register3)
}

suspend fun Instruction.neq(register1: RegisterValue, register2: RegisterValue, register3: RegisterAddress): WriteBackOutput_old {
    useful
    val result = alu_neq(register1.value, register2.value)
    return WriteBackOutput_old(result, register3)
}

suspend fun Instruction.lt(register1: RegisterValue, register2: RegisterValue, register3: RegisterAddress): WriteBackOutput_old {
    useful
    val result = alu_lt(register1.value, register2.value)
    return WriteBackOutput_old(result, register3)
}

suspend fun Instruction.gt(register1: RegisterValue, register2: RegisterValue, register3: RegisterAddress): WriteBackOutput_old {
    useful
    val result = alu_gt(register1.value, register2.value)
    return WriteBackOutput_old(result, register3)
}

suspend fun Instruction.lte(register1: RegisterValue, register2: RegisterValue, register3: RegisterAddress): WriteBackOutput_old {
    useful
    val result = alu_lte(register1.value, register2.value)
    return WriteBackOutput_old(result, register3)
}

suspend fun Instruction.gte(register1: RegisterValue, register2: RegisterValue, register3: RegisterAddress): WriteBackOutput_old {
    useful
